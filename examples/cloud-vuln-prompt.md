...
4. Check object-storage exposure and cloud metadata/temporary-credential indicators with redacted tool output and secure owner-channel handling for exact secrets.
5. Infer impact from redacted in-scope evidence, role/policy context, and observed cloud behavior.
