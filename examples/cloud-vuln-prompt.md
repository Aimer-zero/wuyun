...
4. Check object-storage exposure and cloud metadata/temporary-credential indicators with complete in-scope evidence for the authorized private report.
5. Infer impact from complete in-scope evidence, role/policy context, and observed cloud behavior.
